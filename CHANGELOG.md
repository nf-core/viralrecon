...
- [[PR #619](https://github.com/nf-core/viralrecon/pull/619)] - Update Freyja `2.0.3` → `2.0.4`, fixing the intermittent `FREYJA_BOOT` crash caused by a floating-point rounding bug in `perform_bootstrap` ([#618](https://github.com/nf-core/viralrecon/issues/618))
