...
1. Install [`Nextflow`](https://nf-co.re/usage/installation) (`>=21.04.0-edge`); see [usage docs](https://nf-co.re/rnaseq/usage#nextflow-edge-releases) if the pipeline requires an `edge` release of Nextflow.
