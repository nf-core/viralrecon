...
**nf-core/viralrecon** is a bioinformatics best-practice analysis pipeline for Assembly and intrahost/low-frequency variant calling for viral samples.
...
4. Start running your own analysis!
    ...
    ```console
    nextflow run nf-core/viralrecon -profile <docker/singularity/podman/shifter/charliecloud/conda/institute> --input samplesheet.csv --genome GRCh37
    ```
