...
Please click [here](docs/html/multiqc_report.html) to see an example MultiQC report generated using samples prepared from the ARTIC V1 amplicon set using the parameters defined in [this](conf/test_full.config) file.
