...
[VarScan 2](http://dkoboldt.github.io/varscan/) is a platform-independent software tool developed at the Genome Institute, Washington University to detect variants in NGS data. SAMtools was used to generate the Pileup file which is then passed to VarScan 2 in order to call both high and low frequency variants.
