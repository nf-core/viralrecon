...
MN908947.3 320 342 nCoV-2019_2_LEFT 60 - CTGTTTTACAGGTTCGCGACGT
MN908947.3 704 726 nCoV-2019_2_RIGHT 60 + TAAGGATCAGTGCCAAGCTCGT
```

If you plan to run the same primer set on both Illumina and Nanopore data, please supply a BED7 file if possible so that it works with both iVar and `artic minion`.
