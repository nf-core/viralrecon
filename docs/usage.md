...
* [Kraken](#kraken)
  ...
  * [`--viral_kraken2_name`](#--viral_kraken2_name)
  * [`--kraken2_use_host_db`](#--kraken2_use_host_db)
...
Name for host genome as recognised by Kraken2 when using the `kraken2 build` command as configured on `genomes.config`. Default: 'viral'.

### `--kraken2_use_host_db`

Use Kraken2 host database instead of viral one for filtering reads
