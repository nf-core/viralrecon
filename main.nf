...
def helpMessage() {
    ...
    Sample download
      --sra_api_key                   SRA API key increases the number of requests to NCBI SRA database requests (https://ncbiinsights.ncbi.nlm.nih.gov/2017/11/02/new-api-keys-for-the-e-utilities/)
...
// BEFORE downloading check whether is illumina single or pair etc
