...
process CHECK_SAMPLESHEET {
    ...
    """
    awk -F, '{if(\$1 != "" && \$2 != "") {print \$0}}' $samplesheet > nonsra_ids.csv
    check_samplesheet.py nonsra_ids.csv nonsra.samplesheet.csv
...
//cat nonsra.samplesheet.csv sra.samplesheet.csv > samplesheet.final.csv
