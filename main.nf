...
def helpMessage() {
    ...
    References                        If not specified in the configuration file or you wish to overwrite any of the references
      --genome [str]                  Name of genome reference key for viral genome e.g. 'NC_045512.2'
      --fasta [file]                  Path to fasta reference for viral genome
      --gff [file]                    Full path to viral gff annotation file

      --save_reference [bool]         If generated by the pipeline save the Bowtie2 indices in the results directory (Default: false)

    Kraken2
      --kraken2_db [file]             Full path to Kraken2 database built from host genome
      --kraken2_db_name [str]         Name of host genome for building Kraken2 database e.g. 'human'
...
if (params.gff) { ch_gff = file(params.gff, checkIfExists: true) }
...
//     file ('data/virus/genes.gff') from ch_gff
//
//     output:
