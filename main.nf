...
process FASTQC_TRIM {
    ...
    when:
    !params.skip_fastqc && !params.skip_qc && !params.skip_trimming && !is_sra
...
/*
* STEP 4.1: Align reads with bowtie2
*/
process BOWTIE2 {
    tag "$sample"
    label 'process_medium'
...
//     file ('alignment/*') from ch_sort_bam_flagstat_mqc.collect().ifEmpty([])
//     file ('alignment/*') from ch_sort_bam_picardstat_mqc.collect().ifEmpty([])
