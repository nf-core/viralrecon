...
def helpMessage() {
    ...
    References                        If not specified in the configuration file or you wish to overwrite any of the references
      ...
      --save_reference [bool]         If generated by the pipeline save the Bowtie2 index in the results directory (Default: false)
...
if (params.fasta) {
    ...
    index_base = params.fasta.substring(lastPath+1)
...
if (params.bowtie2_index) {
    ...
    index_dir =  params.bowtie2_index.substring(0,lastPath+1)
    index_base = params.bowtie2_index.substring(lastPath+1)
    Channel
        .fromPath(index_dir, checkIfExists: true)
