...
def helpMessage() {
    ...
    Sample download
      --sra_api_key [str]             SRA API key increases the number of requests to NCBI SRA database requests (https://ncbiinsights.ncbi.nlm.nih.gov/2017/11/02/new-api-keys-for-the-e-utilities/)
...
summary['sra_api_key']            = params.sra_api_key ? 'Yes' : 'No' // correct
