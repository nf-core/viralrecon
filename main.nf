...
ch_fasta
    .into { ch_fasta_bowtie2; ch_fasta_ivar_variants; ch_fasta_ivar_consensus
            ch_fasta_picard; ch_fasta_varscan2; ch_fasta_snpeff; ch_fasta_bcftools;
...
/*
 * STEP 5.3: Trim amplicons, call variants, and generate consensus with IVar
 */
...
// TODO nf-core: Implement QUAST for consensus generated by IVar and BCFTools
// TODO nf-core: Implement IVar for variant calling on metagenomics data too and add snpEff for both
// TODO nf-core: Add --callers 'varscan2,ivar' option
...
/*
 * STEP 5.5: Variant calling with VarScan 2
 */
...
/*
 * STEP 5.6: Variant calling annotation with SnpEff and SnpSift
 */
process SNPEFF {
    tag "$sample"
    label 'process_medium'
...
/*
 * STEP 5.7: Genome consensus generation with BCFtools and masked with BEDTools
 */
...
process MULTIQC {
    ...
    file ('varscan2/highfreq/*') from ch_varscan2_bcftools_highfreq_mqc.collect().ifEmpty([])
    file ('varscan2/lowfreq/*') from ch_varscan2_bcftools_lowfreq_mqc.collect().ifEmpty([])
