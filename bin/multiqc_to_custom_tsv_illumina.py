...
def parse_args(args=None):
    Description = 'Create custom spreadsheet for pertinent MultiQC metrics generated by the nf-core/viralrecon pipeline for Illumina data.'
    Epilog = "Example usage: python multiqc_to_custom_tsv_illumina.py"
...
def main(args=None):
    ...
    VariantFileFieldList = [
        ...
        ('multiqc_picard_wgsmetrics.yaml',                         [('Coverage mean', ['MEAN_COVERAGE']),
                                                                    ('Coverage median', ['MEDIAN_COVERAGE']),
